...
<nav class="menu">
    ...
    <ul class="principal">
        ...
        <li><a href="index_instituicoes.jsp">Instituições</a> </li>
...
<main>
    <form class="informacao-pessoal" method="post" action="/create-funcionario">
        ...
        <input type="radio" name="sexo" value="Feminino" id="sexo">Feminino</label>
        <input type="radio" name="sexo" value="masculino" id="sexo">Masculino</label>
        ...
        <input type="rg" id="rg" name="rg" class="input-padrao" required placeholder="Digite o RG">
        ...
        <textarea name="observacao" id="observacao" cols="100" rows="8" class="area-texto"></textarea>
