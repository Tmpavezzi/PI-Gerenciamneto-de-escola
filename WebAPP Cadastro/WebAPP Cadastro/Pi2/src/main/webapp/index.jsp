...
<div class="container" >
    ...
    <div class="content">
      <!--FORMULÁRIO DE LOGIN-->
      <div id="login">
        <form method="post" action="/create-Gerenciamneto">
      ...
      <div id="cadastro">
        <form method="post" action="/create-Gerenciamneto">
          ...
          <p>
            ...
            <input id="nome_cad" name="nome_cad" required="required" type="text" placeholder="Seu nome"value="${param.name}" />
          </p>
          ...
          <p>
            ...
            <input id="senha_cad" name="senha_cad" required="required" type="password"value="${param.senha}" >
          </p>
